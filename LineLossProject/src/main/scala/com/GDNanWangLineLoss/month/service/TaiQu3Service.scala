        ...
        try{
            val tq_31 =
                s"""
                   ...
                   |    round(t.bygdl/(b.edrl*24*getdayOfMonth()),2) fzl,t.byxsl,t.bygdl,t.bysdl,
            ...
            //供售端计量精度误差清单
            sparkSession.sql(s"select getUUID() id,* from res_gk_yqzxlgsdjljdwcqd").show(5)
...
//            sparkSession.sql(s"select distinct ${creator_id} creator_id,${create_time} create_time,${update_time} update_time,${updator_id} updator_id,gddwbm,xltqbz,xlxdbs,null tqbs,tjzq,tjsj,ycgzbh,getycgzmc(ycgzbh) from res_gk_yqzxlgsdjljdwcqd")
        ...
        try{
            val tq_32 =
                s"""
                   ...
                   |    getxlmc(j.xlxdbs),l.tqbs,
                   |    l.tqbh,l.tqmc,getbdzbs(j.xlxdbs) bdzbs,
                   ...
                   |    getzzmc(getGdsbm(l.gddwbm)) gds,getdmbmmc('YHLBDM',j.yhlbdm) yhlb,getdqbm(l.gddwbm) dqbm,
                   |    ${nybm} nybm
                   |from tq l
            ...
            //工单归档不及时用户电量波动异常清单
            sparkSession.sql(s"select getUUID() id,* from res_gk_gdgdbjsyhdlbdycqd").show(5)
...
//            sparkSession.sql(s"select distinct ${creator_id} creator_id,${create_time} create_time,${update_time} update_time,${updator_id} updator_id,gddwbm,xltqbz,xlxdbs,tqbs,tjzq,tjsj,ycgzbh,getycgzmc(ycgzbh) from res_gk_gdgdbjsyhdlbdycqd")
        ...
        try{
            val tq_33 =
                s"""
                   ...
                   |    getycgzbh(${Constant.TQ_33}) ycgzbh,
            ...
            //表码录入错误工单清单
            sparkSession.sql(s"select getUUID() id,* from res_gk_bmlrcwgdqd").show(5)
...
//            sparkSession.sql(s"select distinct ${creator_id} creator_id,${create_time} create_time,${update_time} update_time,${updator_id} updator_id,gddwbm,xltqbz,xlxdbs,tqbs,tjzq,tjsj,ycgzbh,getycgzmc(ycgzbh) from res_gk_bmlrcwgdqd")
        ...
        try{
            val tq_34 =
                s"""
                   ...
                   |    handleNumber(if(sign(j.scdl)=1,(j.jfdl-j.scdl)/j.scdl,0)) bdl,
                   ...
                   |    getzzmc(getGdsbm(xl.gddwbm)) gds,getdmbmmc('YHLBDM',j.yhlbdm) yhlb,getdqbm(xl.gddwbm) dqbm,
                   |    ${nybm} nybm
                   |from xsycxlhtqmx xl
            ...
            //波动率异常用户电量清单
            sparkSession.sql(s"select getUUID() id,* from res_gk_bdlycyhdlqd").show(5)
...
//            sparkSession.sql(s"select distinct ${creator_id} creator_id,${create_time} create_time,${update_time} update_time,${updator_id} updator_id,gddwbm,xltqbz,xlxdbs,tqbs,tjzq,tjsj,ycgzbh,getycgzmc(ycgzbh) from res_gk_bdlycyhdlqd")
        ...
        try{
            val tq_35 =
                s"""
                   ...
                   |    handleNumber(j.scdl) sqjfdl,
                   |    handleNumber(j.jfdl) bqjfdl,
                   |    0 bdl,getycgzbh(${Constant.TQ_35}) ycgzbh,
