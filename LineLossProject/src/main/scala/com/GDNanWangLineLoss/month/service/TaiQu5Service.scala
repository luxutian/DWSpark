        ...
        try{
            val tq_51 =
                s"""
                   ...
                   |    k1.bdzkhbhh,k2.tqkhbhh,y.yhbh,y.yhmc,y.yhlbdm,g.gzdbh,handleTime(w.chsj) chwqydsj,
                   |    handleNumber(w.yzbdl) wqygdl,handleTime(g.wcsj) gdrq,getycgzbh(${Constant.TQ_51}) ycgzbh,
        ...
        try{
            val tq_52 =
                s"""
                   ...
                   |    getxlmc(t2.xlxdbs),t2.tqbs,t2.tqbh,t2.tqmc,getbdzbs(t2.xlxdbs) bdzbs,getbdzbh(t2.xlxdbs) bdzbh,
                   |    getbdzmc(t2.xlxdbs) bdzmc,k1.bdzkhbhh,k2.tqkhbhh,t2.yhbh,t2.yhmc,t2.yhlbdm,
                   |    handleNumber(t2.glys),handleNumber(t2.jfdl),getycgzbh(${Constant.TQ_52}) ycgzbh,
