    ...
    def line2Service(sparkSession:SparkSession, url:String)={
        ...
        try{
            val xl_21 =
                s"""
                   |select
                   |    distinct ${creator_id},${create_time},${update_time},${updator_id},j.gddwbm,${nowMonth} tjsj,
                   |    ${ybs} tjzq,${xlbz} xltqbz,xl.xlxdbs,xl.xlbh,xl.xlmc,null,null,null,getbdzbs(xl.xlxdbs) bdzbs,
                   |    getbdzbh(xl.xlxdbs) bdzbh,getbdzmc(xl.xlxdbs) bdzmc,k1.bdzkhbhh,null,j.yhbh,j.yhmc,j.yhlbdm,
                   |    jl.gddwbm sygddwbm,getycgzbh(${Constant.XL_21}) ycgzbh,getDsjbm(xl.gddwbm) dsjbm,
        ...
        try{
            val xl_22 =
                s"""
                   ...
                   |    getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,k1.bdzkhbhh,null,y.yhbh,y.yhmc,
                   |    y.yhlbdm,null sygddwbm,getycgzbh(${Constant.XL_22}) ycgzbh,getDsjbm(y.gddwbm) dsjbm,
                   |    getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,getzzmc(getDsjbm(l.gddwbm)) dsj,
                   |    getzzmc(getQxjbm(l.gddwbm)) qxj,getzzmc(getGdsbm(l.gddwbm)) gds,getdmbmmc('YHLBDM',y.yhlbdm) yhlb,getdqbm(l.gddwbm) dqbm,${nybm}
                   |from ydkh y
...
//            sparkSession.sql(s"insert into ${writeSchema}.GK_GDDWWKHBGQD_HIS select getUUID(),*,tjsj fqrq from RES_GK_GDDWWKHBGQD")
        ...
        try{  //什么样的条件下A表要joinB表2次，join的条件不一样
            val xl_23 =
                s"""
                   |select
                   |    distinct ${creator_id},${create_time},${update_time},${updator_id},xl.gddwbm,${nowMonth} tjsj,
                   |    ${ybs} tjzq,${xlbz} xltqbz,xl.xlxdbs,xl.xlbh,xl.xlmc,null,null,null,
                   |    getbdzbs(xl.xlxdbs) bdzbs,getbdzbh(xl.xlxdbs) bdzbh,getbdzmc(xl.xlxdbs) bdzmc,k1.bdzkhbhh,null,
                   |    j.yhbh,j.yhmc,j.yhlbdm,jl.jldydjdm sqdydjdm,j.jldydjdm jldydjdm,getycgzbh(${Constant.XL_23}) ycgzbh,
...
//            sparkSession.sql(s"insert into ${writeSchema}.GK_DFDCHDYDJBGQD_HIS select getUUID(),*,tjsj fqrq from RES_GK_DFDCHDYDJBGQD")
        ...
        try{
            val xl_24 =
                s"""
                   |select
                   |    distinct ${creator_id},${create_time},${update_time},${updator_id},null gddwbm,
                   |    ${nowMonth} tjsj,${ybs} tjzq,${xlbz} xltqbz,null xlxdbs,null xlbh,null xlmc,null,null,null,
                   |    null bdzbs,null bdzbh,null bdzmc,null bdzkhbhh,null,y.yhbh,y.yhmc,y.yhlbdm,
                   |    getycgzbh(${Constant.XL_24}) ycgzbh,getDsjbm(j.gddwbm) dsjbm,getQxjbm(j.gddwbm) qxjbm,
...
//            sparkSession.sql(s"insert into ${writeSchema}.GK_JLDXXDASSXLWKQD_HIS select getUUID(),*,tjsj fqrq from RES_GK_JLDXXDASSXLWKQD")
        ...
        try{
            val xl_25 =
                s"""
                   |select
                   |    distinct ${creator_id},${create_time},${update_time},${updator_id},xsxl.gddwbm,
                   ...
                   |    getbdzmc(xsxl.xlxdbs) bdzmc,k1.bdzkhbhh,null,y.yhbh,y.yhmc,y.yhlbdm,g.xlxdbs xsjlddaxlxdbs,
                   ...
                   |    getycgzbh(${Constant.XL_25}) ycgzbh,getDsjbm(xsxl.gddwbm) dsjbm,getQxjbm(xsxl.gddwbm) qxjbm,
                   |    getGdsbm(xsxl.gddwbm) gdsbm,getzzmc(getDsjbm(xsxl.gddwbm)) dsj,getzzmc(getQxjbm(xsxl.gddwbm)) qxj,getzzmc(getGdsbm(xsxl.gddwbm)) gds,getdmbmmc('YHLBDM',y.yhlbdm) yhlb,getdqbm(xsxl.gddwbm) dqbm,${nybm}
                   |from ydkh y
                   ...
                   |    khtq.tqbh khzhdatqbh,khtq.tqmc khzhdatqmc,getycgzbh(${Constant.XL_25}) ycgzbh,
                   |    getDsjbm(xsxl.gddwbm) dsjbm,getQxjbm(xsxl.gddwbm) qxjbm,getGdsbm(xsxl.gddwbm) gdsbm,
                   |    getzzmc(getDsjbm(xsxl.gddwbm)) dsj,getzzmc(getQxjbm(xsxl.gddwbm)) qxj,getzzmc(getGdsbm(xsxl.gddwbm)) gds,
                   |    getdmbmmc('YHLBDM',y.yhlbdm) yhlb,getdqbm(xsxl.gddwbm) dqbm,${nybm}
                   |from ydkh y
                   |inner join jldxx g on g.yhbh = y.yhbh and g.dfny = ${nowMonth}
                   |inner join jld j on j.yhbh = y.yhbh and j.jldytdm <> '410'
        ...
        try{
            val xl_26 =
                s"""
                   ...
                   |    getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,k1.bdzkhbhh,null,
                   ...
                   |    null,null,null,null,null,null,null,null,getycgzbh(${Constant.XL_26}) ycgzbh,
                   ...
                   |    l.gddwbm,${nowMonth} tjsj,${ybs} tjzq,${xlbz} xltqbz,l.xlxdbs,l.xlbh,l.xlmc,null,null,null,
                   |    getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,k1.bdzkhbhh,null,
        ...
        try{
            val xl_27 =
                s"""
                   ...
                   |    ydx.xlmc,null,null,null,
                   |    getbdzbs(ydx.xlxdbs) bdzbs,getbdzbh(ydx.xlxdbs) bdzbh,
                   |    getbdzmc(ydx.xlxdbs) bdzmc,k1.bdzkhbhh,null,
                   ...
                   |    ydx.xlmc ydhxlmc,getycgzbh(${Constant.XL_27}) ycgzbh,
                   |    getDsjbm(l.gddwbm) dsjbm,getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,
                   |    getzzmc(getDsjbm(l.gddwbm)) dsj,getzzmc(getQxjbm(l.gddwbm)) qxj,getzzmc(getGdsbm(l.gddwbm)) gds,
                   |    getdmbmmc('YHLBDM',y.yhlbdm) yhlb,getdqbm(l.gddwbm) dqbm,${nybm}
            ...
            //光伏三户所属线路不一致清单
            sparkSession.sql(s"select getUUID(),*,tjsj fqrq from res_gk_gfshssxlbyzqd")
        ...
        try{
            val xl_28 =
                s"""
                   |select
                   |    distinct ${creator_id} ,${create_time},${update_time},${updator_id},l.gddwbm,${nowMonth} tjsj,
                   |    ${ybs} tjzq,${xlbz} xltqbz,l.xlxdbs,l.xlbh,l.xlmc,null,null,null,
                   |    getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,
                   |    k1.bdzkhbhh,null,handleTime(null) yxxtzgdkssj,handleTime(null) yxxtzgdjssj,
                   |    d.execute_begin_time zcglxtzgdsjkssj,d.execute_end_time zcglxtzgdsjjssj,
                   |    m.code zcglxtgdyxfsddh,getycgzbh(${Constant.XL_28}) ycgzbh,getDsjbm(l.gddwbm) dsjbm,
                   |    getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,getzzmc(getDsjbm(l.gddwbm)) dsj,
                   |    getzzmc(getQxjbm(l.gddwbm)) qxj,getzzmc(getGdsbm(l.gddwbm)) gds,getdqbm(l.gddwbm) dqbm,${nybm}
                   |from xlxd l
            ...
            //转供电运行方式起止时间不一致清单
            sparkSession.sql(s"select getUUID(),*,tjsj fqrq from res_gk_zgdyxfsqzsjbyzqd")
        ...
        try{
            val xl_29 =
                s"""
                    ...
                    |   l.gddwbm,${nowMonth} tjsj,${ybs} tjzq,${xlbz} xltqbz,l.xlxdbs,l.xlbh,l.xlmc,null,null,null,
                    |   getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,k1.bdzkhbhh,null,
                    |   y.yhbh,y.yhmc,y.yhlbdm,handleNumber(j.jfdl),d.ykgdbh,handleTime(g.sqsj),handleTime(g.wcsj),getycgzbh(${Constant.XL_29}) ycgzbh,
                    |   getDsjbm(l.gddwbm) dsjbm,getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,
                    |   getzzmc(getDsjbm(l.gddwbm)) dsj,getzzmc(getQxjbm(l.gddwbm)) qxj,getzzmc(getGdsbm(l.gddwbm)) gds,
                    |   getdmbmmc('YHLBDM',y.yhlbdm) yhlb,getdqbm(l.gddwbm) dqbm,${nybm}
                    |from ydkh y
...
//            sparkSession.sql(s"insert into ${writeSchema}.GK_DABGDZHYJBJSQD_HIS select getUUID(),*,tjsj fqrq from RES_GK_DABGDZHYJBJSQD")
        ...
        try{
            val xl_210 =
                s"""
                    |select
                    |   ${creator_id},${create_time},${update_time},${updator_id},l.gddwbm,
                    |   ${nowMonth} tjsj,${ybs} tjzq,${xlbz} xltqbz,l.xlxdbs,l.xlbh,l.xlmc,null tqbs,null tqbh,null tqmc,
                    |   getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,
                    |   k1.bdzkhbhh,null,j.yhbh,j.yhmc,j.yhlbdm,handleNumber(sw.swdl) swdl,null fxygdl,getycgzbh(${Constant.XL_210}) ycgzbh,
                    |   getDsjbm(l.gddwbm) dsjbm,getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,
                    |   getzzmc(getDsjbm(l.gddwbm)) dsj,getzzmc(getQxjbm(l.gddwbm)) qxj,getzzmc(getGdsbm(l.gddwbm)) gds,
                    ...
                    |
                    |union
                    |select ${creator_id},${create_time},${update_time},${updator_id},l.gddwbm,
                    |   ${nowMonth} tjsj,${ybs} tjzq,${xlbz} xltqbz,l.xlxdbs,l.xlbh,l.xlmc,null tqbs,null tqbh,null tqmc,
                    |   getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,
                    |   k1.bdzkhbhh,null,j.yhbh,j.yhmc,j.yhlbdm,handleNumber(sw.swdl) swdl,null fxygdl,getycgzbh(${Constant.XL_210}) ycgzbh,
                    |   getDsjbm(l.gddwbm) dsjbm,getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,
        ...
        try{
            val xl_211 =
                s"""
                   ...
                   |    null,null,null,getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,
                   |    k1.bdzkhbhh,null,y.yhbh,y.yhmc,y.yhlbdm,y.yhztdm yxztdm,handleNumber(x.jfdl),
                   |    getycgzbh(${Constant.XL_211}) ycgzbh,getDsjbm(l.gddwbm) dsjbm,getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,
                   |    getzzmc(getDsjbm(l.gddwbm)) dsj,getzzmc(getQxjbm(l.gddwbm)) qxj,
                   |    getzzmc(getGdsbm(l.gddwbm)) gds,getdmbmmc('YHLBDM',y.yhlbdm) yhlb,
                   |    getdmbmmc('YXZT',y.yhztdm) yhzt,getdqbm(l.gddwbm) dqbm,${nybm}
                   |from ydkh y
        ...
        try{
            val xl_212 =
                s"""
                   ...
                   |    ${nowMonth} tjsj,${ybs} tjzq,${xlbz} xltqbz,l.xlxdbs,l.xlbh,l.xlmc,null,null,null,
                   |    getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,
                   |    k1.bdzkhbhh,null,y.yhbh,y.yhmc,y.yhlbdm,c.eddydm dnbeddydm,j.jlfsdm jlfsdm,
                   |    getycgzbh(${Constant.XL_212}) ycgzbh,getDsjbm(l.gddwbm) dsjbm,getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,
                   |    getzzmc(getDsjbm(l.gddwbm)) dsj,getzzmc(getQxjbm(l.gddwbm)) qxj,
                   |    getzzmc(getGdsbm(l.gddwbm)) gds,getdmbmmc('YHLBDM',y.yhlbdm) yhlb,getdmbmmc('DNBEDDY',c.eddydm) DNBEDDY,getdmbmmc('JLFSDM',j.jlfsdm) JLFS,getdqbm(l.gddwbm) dqbm,${nybm}
                   |from ydkh y
                   |inner join jld j on j.yhbh = y.yhbh and j.jldytdm <> '410'
            ...
            //计量辅助判断用户类别异常清单
            sparkSession.sql(s"select getUUID(),*,tjsj fqrq from res_gk_jlfzpdyhlbycqd")
        ...
        try{
            val xl_213 =
                s"""
                    ...
                    |   xl.xlmc,null,null,null,getbdzbs(xl.xlxdbs) bdzbs,getbdzbh(xl.xlxdbs) bdzbh,getbdzmc(xl.xlxdbs) bdzmc,
                    |   k1.bdzkhbhh,null,y.yhbh,y.yhmc,y.yhlbdm,yw.ywbm ywlxdm,g.gzdbh ywgzdbh,
                    |   handleNumber(j.jfdl),getycgzbh(${Constant.XL_213}) ycgzbh,getDsjbm(xl.gddwbm) dsjbm,
                    |   getQxjbm(xl.gddwbm) qxjbm,getGdsbm(xl.gddwbm) gdsbm,
                    |   getzzmc(getDsjbm(xl.gddwbm)) dsj,getzzmc(getQxjbm(xl.gddwbm)) qxj,
                    |   getzzmc(getGdsbm(xl.gddwbm)) gds,getdmbmmc('YHLBDM',y.yhlbdm) yhlb,yw.ywbmmc ywlx,getdqbm(xl.gddwbm) dqbm,${nybm}
                    |from xsycxlhtqmx xl
