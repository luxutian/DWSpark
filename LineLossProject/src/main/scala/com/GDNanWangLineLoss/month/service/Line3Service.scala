        ...
        try{
            val xl_31 =
                s"""
                   ...
                   |    ${nowMonth} tjsj,${ybs} tjzq,${xlbz} xltqbz,t.xlxdbs,t.xlbh,t.xlmc,null,null,null,
                   |    getbdzbs(t.xlxdbs) bdzbs,getbdzbh(t.xlxdbs) bdzbh,getbdzmc(t.xlxdbs) bdzmc,k1.bdzkhbhh,
                   |    null,null fzl,t.byxsl,t.bygdl,t.bysdl,getycgzbh(${Constant.XL_31}) ycgzbh,getDsjbm(t.gddwbm) dsjbm,
...
//            sparkSession.sql(s"insert into ${writeSchema}.gk_yqzxlgsdjljdwcqd_his select getUUID(),*,tjsj fqrq from res_gk_yqzxlgsdjljdwcqd")
        ...
        try{
            val xl_32 =
                s"""
                   |select
                   |    distinct ${creator_id},${create_time},${update_time},${updator_id},t.gddwbm,${nowMonth} tjsj,
                   ...
                   |    k1.bdzkhbhh,null,j.yhbh,j.yhmc,j.yhlbdm,j.jldbh,d.zcbh,g.gzdbh gdh,null gzdmc,handleNumber(j.jfdl) bqdl,
                   |    handleNumber(j.scdl) sqdl,getycgzbh(${Constant.XL_32}) ycgzbh,getDsjbm(t.gddwbm) dsjbm,
        ...
        try{
            val xl_33 =
                s"""
                   ...
                   |    getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,
                   |    k1.bdzkhbhh,null,j.yhbh,j.yhmc,j.yhlbdm,j.jldbh,d.zcbh,g.gzdbh gdh,handleNumber(c.scbss) qm,
                   |    handleNumber(c.bcbss) zm,handleNumber(j.jfdl) bydl,handleNumber(j.scdl) sydl,
        ...
        try{
            val xl_34 =
                s"""
                   ...
                   |    null,j.yhbh,j.yhmc,j.yhlbdm,j.jldbh,d.zcbh,g.gzdbh zngdh,handleNumber(j.scdl) sqdl,
        ...
        try{
            val xl_35 =
                s"""
                   ...
                   |    getbdzbs(l.xlxdbs) bdzbs,getbdzbh(l.xlxdbs) bdzbh,getbdzmc(l.xlxdbs) bdzmc,k1.bdzkhbhh,
                   |    null,j.yhbh,j.yhmc,j.yhlbdm,j.jldbh,d.zcbh,g.gzdbh zngdh,handleNumber(j.scdl) sqdl,
                   |    handleNumber(j.jfdl) bqdl,getycgzbh(${Constant.XL_35}) ycgzbh,
                   |    getDsjbm(l.gddwbm) dsjbm,getQxjbm(l.gddwbm) qxjbm,getGdsbm(l.gddwbm) gdsbm,
                   |    getzzmc(getDsjbm(l.gddwbm)) dsj,getzzmc(getQxjbm(l.gddwbm)) qxj,getzzmc(getGdsbm(l.gddwbm)) gds,
                   |    getdmbmmc('YHLBDM',j.yhlbdm) yhlb,getdqbm(l.gddwbm) dqbm,${nybm}
                   |from xsycxlhtqmx l
        ...
        try{
            val xl_36 =
                s"""
                   ...
                   |    k1.bdzkhbhh,null,j.yhbh,j.yhmc,j.yhlbdm,j.jldbh,d.zcbh,handleNumber(j.scdl) sqjfdl,
                   |    handleNumber(j.jfdl) bqjfdl,0 bdl,getycgzbh(${Constant.XL_36}) ycgzbh,
