        ...
        try{
            val tq_41 =
                s"""
                   ...
                   |    k1.bdzkhbhh,k2.tqkhbhh,handleNumber(s.sxfhbphl),getycgzbh(${Constant.TQ_41}) ycgzbh,
                   ...
                   |    getzzmc(getgdsbm(t.gddwbm)) gds,getdqbm(t.gddwbm) dqbm,${nybm}
                   |from ydkh y
            ...
            //三相负荷不平衡清单
            sparkSession.sql(s"select getUUID(),*,tjsj fqrq from res_gk_sxfhbphqd")
        ...
        try{
            val tq_43 =
                s"""
                   ...
                   |    t.xlbh,t.xlmc,t.tqbs,t.tqbh,t.tqmc,getbdzbs(t.xlxdbs) bdzbs,getbdzbh(t.xlxdbs) bdzbh,
                   |    getbdzmc(t.xlxdbs) bdzmc,k1.bdzkhbhh,k2.tqkhbhh,'重过载' fzqk,
                   |    round(t.bygdl/(b.edrl*24*getdayOfMonth()),2) fzl,getycgzbh(${Constant.TQ_43}) ycgzbh,
                   |    getDsjbm(t.gddwbm) dsjbm,getQxjbm(t.gddwbm) qxjbm,getGdsbm(t.gddwbm) gdsbm,
            ...
            //重过载轻载清单
            sparkSession.sql(s"select getUUID(),*,tjsj fqrq from res_gk_zgzqzqd")
        ...
        try{
            val tq_44 =
                s"""
                   ...
                   |    ${ybs} tjzq,${tqbz} xltqbz,t.xlxdbs,t.xlbh,t.xlmc,t.tqbs,t.tqbh,t.tqmc,
                   |    getbdzbs(t.xlxdbs) bdzbs,getbdzbh(t.xlxdbs) bdzbh,
                   |    getbdzmc(t.xlxdbs) bdzmc,k1.bdzkhbhh,k2.tqkhbhh,'轻载'  fzqk,
                   |    round(t.bygdl/(b.edrl*24*getdayOfMonth()),2) fzl,getycgzbh(${Constant.TQ_44}) ycgzbh,
                   |    getDsjbm(t.gddwbm) dsjbm,getQxjbm(t.gddwbm) qxjbm,getGdsbm(t.gddwbm) gdsbm,
                   |    getzzmc(getDsjbm(t.gddwbm)) dsj,getzzmc(getQxjbm(t.gddwbm)) qxj,
                   |    getzzmc(getGdsbm(t.gddwbm)) gds,getdqbm(t.gddwbm) dqbm,${nybm}
                   |from tqxstjxx t
        ...
        try{
            val tq_46 =
                s"""
                   ...
                   |    t.xlmc,t.tqbs,t.tqbh,t.tqmc,getbdzbs(t.xlxdbs) bdzbs,getbdzbh(t.xlxdbs) bdzbh,
                   |    getbdzmc(t.xlxdbs) bdzmc,k1.bdzkhbhh,k2.tqkhbhh,handleNumber(a.dxyhsl) dxdnbsl,
                   |    handleNumber(a.dxshdl) dxdnbshdl,handleNumber(a.sxyhsl) sxdnbsl,
                   |    handleNumber(a.sxshdl) sxdnbshdl,handleNumber(a.dxshdl+a.sxshdl) zshdl,
            ...
            //电能表损耗清单
            sparkSession.sql(s"select getUUID(),*,tjsj fqrq from res_gk_dnbshqd")
...
//            sparkSession.sql(s"insert into ${writeSchema}.GK_DNBSHQD_HIS select getUUID(),*,tjsj fqrq from res_gk_dnbshqd")
            ...
            sparkSession.sql(s"select distinct ${creator_id},${create_time},${update_time},${updator_id},gddwbm,xltqbz,xlxdbs,tqbs,tjzq,tjsj,ycgzbh,getycgzmc(ycgzbh) from res_gk_dnbshqd")
